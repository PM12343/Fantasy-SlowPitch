...
if "my_team" not in st.session_state:               # Your 12-player roster
    st.session_state.my_team = []
if "opponent_main_team" not in st.session_state:    # NEW: Opponent's 12-player roster
    st.session_state.opponent_main_team = []
if "h2h_my_team" not in st.session_state:           # Your 10-player H2H
    st.session_state.h2h_my_team = []
if "opponent_team" not in st.session_state:         # Opponent's 10-player H2H
...
OPPONENT_MAIN_FILE = "opponent_main_roster.json"    # NEW
...
with st.sidebar:
    ...
    if st.button("Load Opponent 12-player Roster"):          # NEW
...
with tab_browser:
    ...
    col_search, col_refresh = st.columns([4, 
